...
Author: Daniel Aparicio Gamo (@gamogestionweb)
...
# =============================================================================
#  CASE STUDY #1: DANIEL APARICIO GAMO
# =============================================================================

def build_daniel_gamo() -> CognitiveSignaturePlatform:
    
    subject = Subject(
        name="APARICIO GAMO, DANIEL",
        date_of_birth="1992-01-20",
        sex="M",
        identifiers={"cipa": "1206905423", "nss": "28/13239435-39"}
    )
    ...
    platform.add_brain(BrainStructure(
        scan_date="2024",
        scan_type="CT",
        signature_id="BRAIN-5C13EB2BADEB",
        total_volume=5294.31, gray_matter=1717.47, white_matter=566.54,
        csf=160.58, ventricles=27.48,
        gray_white_ratio=3.03, gyrification_index=5.33,
        hemispheric_asymmetry=3.30, dominant_hemisphere="Left",
        frontal=32.1, parietal=24.8, temporal=21.5, occipital=14.2, central=7.4,
    ))
    
    # === BLOOD #1 — August 2023 (H.U. 12 de Octubre) ===
    platform.add_blood(BloodSample(
        date="2023-08-07", age_at_draw=31,
        source="Hospital Universitario 12 de Octubre, Madrid",
        rbc=4.48, hemoglobin=14.0, hematocrit=42.3, mcv=94.4, mch=31.2, mchc=33.1, rdw=13.5,
        wbc=6.2, neutrophils=2.7, neutrophils_pct=44.3, lymphocytes=2.6, lymphocytes_pct=41.5,
        monocytes=0.5, monocytes_pct=7.3, eosinophils=0.4, eosinophils_pct=6.1,
        basophils=0.0, basophils_pct=0.8, platelets=189, mpv=9.2,
        glucose=71, creatinine=1.16, gfr="83", sodium=144, potassium=4.06, chloride=104,
        alt=20, ast=18, ggt=24, bilirubin=0.4,
        total_cholesterol=195, triglycerides=103, hdl=55, ldl=119, non_hdl=139.5,
        vitamin_b12=424.0, folic_acid=2.5, iron=107, hba1c=5.4,
    ))
    
    # === BLOOD #2 — October 2025 (H.U. 12 de Octubre) ===
    platform.add_blood(BloodSample(
        date="2025-10-17", age_at_draw=33,
        source="Hospital Universitario 12 de Octubre, Madrid",
        rbc=4.80, hemoglobin=15.1, hematocrit=46.2, mcv=96.2, mch=31.5, mchc=32.7, rdw=13.4,
        wbc=7.7, neutrophils=3.1, neutrophils_pct=39.6, lymphocytes=3.2, lymphocytes_pct=42.1,
        monocytes=0.6, monocytes_pct=8.2, eosinophils=0.7, eosinophils_pct=9.2,
        basophils=0.1, basophils_pct=0.9, platelets=199, mpv=9.4,
        glucose=71, creatinine=0.96, gfr=">90", sodium=142, potassium=4.08, chloride=100,
        alt=23, ast=24, ggt=38, bilirubin=0.4,
        total_cholesterol=205, triglycerides=64, hdl=71, ldl=121, non_hdl=133.6,
        tsh=3.09, ft4=1.64,
    ))
    
    # === URINE ===
    platform.add_urine(UrineSample(
        date="2023-08-07", ph=5.5, density=1012,
        creatinine=119.1, albumin=0.90, acr=7.56,
    ))
    platform.add_urine(UrineSample(date="2024-12-16", ph=6.5, density=1018))
    
    # === TOXICOLOGY ===
    platform.add_tox(ToxScreen(
        date="2024-12-16", source="H.G.U. Gregorio Marañón",
        results={
